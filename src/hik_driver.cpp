...
std::vector<MV_CC_DEVICE_INFO> get_all_camera()
{
    ...
    for (int index = 0; index < m_stDevList.nDeviceNum; index++)
    {
        ...
        {
            std::cout.width(15);
            std::cout << "Type" << ": Gige" << std::endl;
            std::cout.width(15);
            std::cout << "Serial Number" << ": " << m_stDevInfo.SpecialInfo.stGigEInfo.chSerialNumber << std::endl;
            std::cout.width(15);
            std::cout << "Model Name" << ": " << m_stDevInfo.SpecialInfo.stGigEInfo.chModelName << std::endl;
            ...
            std::cout.width(15);
            std::cout << "Net Export" << ": " << m_stDevInfo.SpecialInfo.stGigEInfo.nNetExport << std::endl;
        ...
        else if (m_stDevInfo.nTLayerType == MV_USB_DEVICE)
        {
            ...
            std::cout.width(15);
            std::cout << "Serial Number" << ": " << m_stDevInfo.SpecialInfo.stUsb3VInfo.chSerialNumber << std::endl;
            std::cout.width(15);
            std::cout << "Device Number" << ": " << m_stDevInfo.SpecialInfo.stUsb3VInfo.nDeviceNumber << std::endl;
            std::cout.width(15);
            std::cout << "Model Name" << ": " << m_stDevInfo.SpecialInfo.stUsb3VInfo.chModelName << std::endl;
            std::cout.width(15);
            std::cout << "Device GUID" << ": " << m_stDevInfo.SpecialInfo.stUsb3VInfo.chDeviceGUID << std::endl;
            cameras.push_back(m_stDevInfo);
        }
    }
    return cameras;
